...
var Hand = {
  ...
  useSet: function(index, style, callback) {
  ...
  draw: function(canvas, x, y, angle, prevHand, fps = 15) {
    ...
    if (this.currentSet) {
      ...
      if (prevHand) {
        ...
        if (blurRadius > 2) {
          ...
          tempCtx.drawImage(hand.img, canvasPadding, canvasPadding, handWidth * bluredHandScale, handHeight * bluredHandScale);
      ...
      ctx.drawImage(
        drawBlurred ? tempCanvas : hand.img,
        x - handPenX,
        y - handPenY,
